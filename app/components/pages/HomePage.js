...
function HomePage() {
  return (
    <div className="l-page">
      <Banner />
      <div className="row l-content -home -short">
        <div className="column small-12 medium-10 medium-offset-1">
          <h2 className="header -intro -center">What can I use this tool for?</h2>
        </div>
        <ul className="column c-use-cases">
          <li className="column small-12 medium-4 use">
            <svg>
              <use xlinkHref="#illustration-1"></use>
            </svg>
            <h3 className="header -intro">Search for a country<br />and see all the ocurring species</h3>
          </li>
          <li className="column small-12 medium-4 use">
            <svg>
              <use xlinkHref="#illustration-2"></use>
            </svg>
            <h3 className="header -intro">See the data<br />for a particular site</h3>
          </li>
          <li className="column small-12 medium-4 use">
            <svg>
              <use xlinkHref="#illustration-3"></use>
            </svg>
            <h3 className="header -intro">Search for a species<br />and see its critical sites</h3>
          </li>
        </ul>
