          ...
          <div className="column small-12 medium-3">
            <Sticky topOffset={-50} activeClass="stickyMenu">
              <div className="c-side-menu">
                <Link activeClass="active" to="guidance" spy smooth offset={-70} duration={500}>
                  Guidance
                </Link>
                <Link activeClass="active" to="wetland-waterbird" spy smooth offset={-70} duration={500}>
                  Guidance for wetland and waterbird management
                </Link>
                <Link activeClass="active" to="climate-change" spy smooth offset={-70} duration={500}>
                  Guidance on climate change adaptation
                </Link>
                <Link activeClass="active" to="user-guide" spy smooth offset={-70} duration={500}>
                  User Guide - Examples
                </Link>
              </div>
            </Sticky>
