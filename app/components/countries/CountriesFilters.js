    ...
    <div className="row c-table-filters">
      <div className="column small-12 medium-8">
        <div className="tags">
          ...
          <NavLink to={`/countries/${props.country}/triggerSuitability`} i18nText="triggerSuitability" className={props.category && props.category === 'triggerSuitability' ? 'is-active' : ''} />
