export const translations = {
  en: {
    ...
    'protected': 'Protected',
    'family': 'Family',
    'confusion_name': 'Look-alike name',
  ...
  fr: {
    ...
    'site_name': 'Nom IBA',
    'csn_site_name': 'Nom de site critique',
    'csn_name': 'Site critique',
    'scientific_name': 'Nom scientifique',
    'english_name': 'Nom anglais',
    'protected': 'Protégé',
    'family': 'Famille',
    'confusion_name': 'Nom semblable',
    'confusion_species': "No. de populations d'espèces semblables",
    'confusion_species_as': "No. de populations d'espèces dans la Col A",
    'confusion_population': 'Population',
    'genus': 'Genre',
    'country_status': 'Statut',
    ...
    'iba_criteria': 'Critères IBA',
    'iba_species': "No. d'espèces qualifiées IBA",
    ...
    'original_b': 'B',
    'original_c': 'C',
    'flyway_range': 'Voie de migration multispécifique',
    'caf_action_plan': 'CMS CAF',
    ...
    'table_1_status': 'Tableau 1 statut',
    'total_percentage': '% Total',
    'ramsarCriterionTool': 'Critère Ramsar 6',
    'ramsarCriterionToolTitle': 'Critère Ramsar 6 Seuils',
    'habitats': 'Habitats',
    'habitat_name': "Nom de l'habitat",
    'habitat_level_1': "Niveau d'habitat 1",
    'habitat_level_2': "Niveau d'habitat 2",
    ...
    'selectAnotherPoint': 'Sélectionnez un autre point',
    ...
    'end' : 'Fin',
    'units' : 'Unités',
    'percentfly': 'Pourcentage de voie de migration',
    'csn1': 'CSN 1',
    'csn2': 'CSN 2',
    'map': 'Carte',
    'table': 'Tableau',
    ...
    'iba_qualifying_species': 'IBA espèces éligibles',
    'csn_qualifying_species': 'CSN espèces éligibles',
    'iba_in_danger': 'IBA en Danger',
    'toolUse': 'Que puis-je utiliser cet outil pour?',
    'searchSites': 'Rechercher des sites',
    'searchSpecies': "Recherche d'espèces",
    'searchPopulations': 'Recherche des populations',
    'searchForCountry': 'Rechercher un pays',
    'seeOccurringSpecies': 'et voir toutes les espèces qui se produisent',
    ...
    'introText1': "L'outil facilite l'obtention d'informations sur les sites critiques pour les espèces d'oiseaux d'eau en accédant à plusieurs bases de données indépendantes et en analysant les informations au niveau de la population biogéographique, fournissant ainsi une base complète pour la gestion et la prise de décision. Il est conçu pour aider un large éventail d'utilisateurs, des gestionnaires de sites aux autorités nationales et aux organisations internationales. L'outil CSN, l'une des principales réalisations du projet Wings Over Wetlands (WOW), illustre également la valeur ajoutée de la coopération entre des organisations de conservation, des conventions et des accords internationaux, des gouvernements, des agences des Nations Unies et d'autres donateurs.",
